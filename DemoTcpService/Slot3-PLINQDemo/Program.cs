...
namespace Slot3_PLINQDemo
{
    internal class Program
    {
...

        {
            ...
            resultList = range.AsParallel().Where(i => 1 % 3 == 0).ToList();
        ...
        static void Demo2()
        {
            ...
            $" (primeNumbers FromForeach.Count) | Time Taken:" +
            $"イwatch,ElapsedMilliseconds me.");
            Console.WriteLine($"Parallel.ForEach loop | Total prime numbers:" +
            $"(primeNumbers From ParallelForeach.Count) | Time Taken:" +
